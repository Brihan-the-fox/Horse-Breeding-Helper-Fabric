...
public class HorseHighlightRenderer {
    ...
    private static void renderHorseHighlights(MatrixStack matrices, net.fabricmc.fabric.api.client.rendering.v1.WorldRenderContext context) {
        MinecraftClient client = MinecraftClient.getInstance();
    ...
    private static void drawHorseOutlineBox(MatrixStack matrices, HorseEntity horse, int color, Vec3d cameraPos, net.fabricmc.fabric.api.client.rendering.v1.WorldRenderContext context) {
        matrices.push();
    ...
    private static void drawTopHorseHighlight(MatrixStack matrices, HorseEntity horse, Vec3d cameraPos, net.fabricmc.fabric.api.client.rendering.v1.WorldRenderContext context) {
        matrices.push();
